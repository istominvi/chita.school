      ...
      <div className="relative z-10 grid items-center gap-8 md:grid-cols-[minmax(0,1fr)_minmax(260px,38%)] lg:grid-cols-[minmax(0,1fr)_minmax(360px,42%)]">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 grid gap-3 sm:flex sm:flex-wrap">
            ...
            >
              <span className="relative h-8 w-8 overflow-hidden rounded-xl shadow-sm" aria-hidden="true">
                <Image src="/MAX.svg" alt="" fill sizes="32px" className="object-contain" />
              </span>
              MAX
            </a>
            <a
            ...
            >
              <span className="relative h-8 w-8 overflow-hidden rounded-full shadow-sm" aria-hidden="true">
                <Image src="/Telegram.svg" alt="" fill sizes="32px" className="object-contain" />
              </span>
              Telegram
            </a>
          </div>
