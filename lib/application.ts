...
export const APPLICATION_REQUEST_TYPES = {
  ...
  prep: "Пользователь хочет записаться на подготовку к школе",
  openDay: "Пользователь хочет записаться на день знакомства с группой продлённого дня 26 сентября в 10:00",
} as const
